...
def format_title(title: str):
    formatted_title = f"<div style='padding:10px;background-color:rgb(230, 0, 172, 204, 0, 153);border-radius:10px'><h1 style='color:rgb(0, 255, 255);text-align:center;'>{title}</h1></div>"
